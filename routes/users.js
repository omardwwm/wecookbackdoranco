...
// router.get('/professionnals', async (req, res)=>{
//     try{
...
//         callback(null, "./public/picturesProfile/");
//     },
...
// });
router.post('/register', multer, controllerUser.createUser);
// router.post('/register', multer ,async (req, res)=>{
...
//Update a user
router.patch('/update', auth, multer, controllerUser.updateUser)
// router.patch('/update', auth, upload.single("profilePicture"), async(req, res)=>{
//     try {
...
router.put('/updatePicture/:id', auth, multer, controllerUser.updateUserPicture);
// router.put('/updatePicture/:id', auth, upload.single("profilePicture"), async (req, res) => {
...
// router.post('/metadata/add/:userId', auth, async (req, res) => {
//     try {
...
// router.put('/metadata/update/:userId', auth, async (req, res) => {
//     try {
//         const userId = req.params.userId;
//         const { userPresentation, userKitchenStyles, userEstablissement } = req.body;
